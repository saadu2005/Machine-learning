"""Decision Tree Regression with preprocessing."""
import numpy as np
...
m=Pipeline([('imputer',SimpleImputer(strategy='median')),('regressor',DecisionTreeRegressor(max_depth=5,random_state=42))]); m.fit(Xt,yt); p=m.predict(Xv)
