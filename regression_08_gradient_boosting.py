"""Gradient Boosting Regression with preprocessing."""
import numpy as np
...
m=Pipeline([('imputer',SimpleImputer(strategy='median')),('regressor',GradientBoostingRegressor(n_estimators=150,random_state=42))]); m.fit(Xt,yt); p=m.predict(Xv)
